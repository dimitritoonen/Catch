    ...
    js: {
      ...
      requireJs: {
        ...
        bundles: {
          ...
          'add-activity-mobile': [
            'components/workspace-page/activity-page/add-activity-mobile/activity-add-description/activity-add-description',
            'components/workspace-page/activity-page/add-activity-mobile/activity-add-category/activity-add-category',
            'components/workspace-page/activity-page/add-activity-mobile/activity-add-location/activity-add-location',
            'components/workspace-page/activity-page/add-activity-mobile/activity-add-participants/activity-add-participants'
          ],
          'add-activity': [
