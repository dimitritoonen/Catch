...
IF DEFINED KUDU_SELECT_NODE_VERSION_CMD (
  ...
  call %KUDU_SELECT_NODE_VERSION_CMD% "%DEPLOYMENT_SOURCE%\src\Chirping.Web" "%DEPLOYMENT_TARGET%" "%DEPLOYMENT_TEMP%"
  IF !ERRORLEVEL! NEQ 0 goto error
...
echo 3. Install and update bower packages
IF EXIST bower.json (
	call :ExecuteCmd ".\node_modules\.bin\bower" install --production ".\bower.json"
	IF !ERRORLEVEL! NEQ 0 goto error
)
